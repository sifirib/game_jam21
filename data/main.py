...
animated_moon = pygame.image.load(os.path.join(os.path.dirname(__file__), '..', 'resources', 'images', "moon.png")).convert_alpha()
...
# camera = Camera(char)
follow = Follow(char.camera, char)
# border = Border(camera, char)
# auto = Auto(camera, char)
char.camera.setmethod(follow)
